...
internal static class UnSwizzleHelpers
{
    public static byte[] UnSwizzlePixels(this byte[] pixelBufferVar, ImgOptions imgOptions)
    {
    ...
    public static byte[] UnSwizzlePalette(this byte[] paletteBuffer)
    {
